...
public class W03Tag3SehrLangerStringTXTAusgabe {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // Schreiben des Files
            ps.println("1.: Anzahl der Zeichen: " + textLength(text));
            ps.println("2.: Anzahl Charaktere: " + textLengthStrip(text));
            ps.print("3.: Anzahl Worte: " + wordCount(text));
            ps.println(" 3a.: Clemens Anzahl Wort: " + wordCountClemens(text));
            ps.print("4.: Längstes Wort: " + longestString(text));
            ps.println(" 4a .: Kürzestes Wort: " + shortestString(text));
            ps.println("5.: erstes Wort alphabetisch: " + firstWord(text));
...
//            if (String.valueOf(textArrayS[i].charAt(0)).equals(String.valueOf(textArrayS[i].charAt(0)).toUpperCase())) // Funktioniert auch. Aber die Lösung in der Zeile darunter ist einfacher.
    ...
    public static int wordCountClemens(String text) {
        ...
        for (int i = 1; i < text.length(); i++) {
            ...
            if (Character.isLetter(charOne) == true && Character.isLetter(charTwo) == false)
                words++; // Zählt ob davor bzw danach immer ein bzw kein Buchstabe ist.
